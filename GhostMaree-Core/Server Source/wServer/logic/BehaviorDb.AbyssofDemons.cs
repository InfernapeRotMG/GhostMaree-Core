        ...
        private _ AbyssofDemons = () => Behav()
            ...
            .Init("Archdemon Malphas",
                ...
                new Threshold(0.01,
                    ...
                    new ItemLoot(item: "Sword of Illumination", probability: 0.01),
                    new ItemLoot(item: "Golden Skull", probability: 0.03),
                    new ItemLoot(item: "Golden Femur", probability: 0.03),
                    new ItemLoot(item: "Golden Ribcage", probability: 0.03)
                )
            )
            .Init("Malphas Flamer",
                new State(
