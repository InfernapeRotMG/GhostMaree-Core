        ...
        .Init("Candy Gnome",
            ...
            .Init("MegaRototo",
                ...
                new Threshold(0.01,
                    ...
                    new ItemLoot(item: "Ring of Pure Wishes", probability: 0.02),
            ...
            .Init("Spoiled Creampuff",
                ...
                new Threshold(0.01,
                    ...
                    new ItemLoot(item: "Candy Ring", probability: 0.015),
                    new ItemLoot(item: "Wine Cellar Incantation", probability: 0.02),
                    new ItemLoot(item: "Rock Candy", probability: 0.08),
                    new ItemLoot(item: "Candy-Coated Armor", probability: 0.01),
                    new ItemLoot(item: "Red Gumball", probability: 0.15),
            ...
            .Init("Desire Troll",
                ...
                new Threshold(0.01,
                    ...
                    new ItemLoot(item: "Potion of Widom", probability: 0.05),
                    new ItemLoot(item: "Candy Ring", probability: 0.015),
                    new ItemLoot(item: "Seal of the Enchanted Forest", probability: 0.015),
                    new ItemLoot(item: "Wine Cellar Incantation", probability: 0.02),
                    new ItemLoot(item: "Rock Candy", probability: 0.08),
                    new ItemLoot(item: "Candy-Coated Armor", probability: 0.01),
                    new ItemLoot(item: "Red Gumball", probability: 0.15),
            ...
            .Init("Swoll Fairy",
                ...
                new Threshold(0.01,
                    ...
                    new ItemLoot(item: "Potion of Widom", probability: 0.05),
                    new ItemLoot(item: "Candy Ring", probability: 0.015),
                    new ItemLoot(item: "Fairy Plate", probability: 0.015),
                    new ItemLoot(item: "Wine Cellar Incantation", probability: 0.02),
                    new ItemLoot(item: "Rock Candy", probability: 0.08),
                    new ItemLoot(item: "Candy-Coated Armor", probability: 0.01),
                    new ItemLoot(item: "Red Gumball", probability: 0.15),
            ...
            .Init("Gigacorn",
                ...
                new Threshold(0.01,
                    ...
                    new ItemLoot(item: "Potion of Widom", probability: 0.05),
                    new ItemLoot(item: "Candy Ring", probability: 0.015),
                    new ItemLoot(item: "Pixie-Enchanted Sword", probability: 0.015),
                    new ItemLoot(item: "Wine Cellar Incantation", probability: 0.02),
                    new ItemLoot(item: "Rock Candy", probability: 0.08),
                    new ItemLoot(item: "Candy-Coated Armor", probability: 0.01),
                    new ItemLoot(item: "Red Gumball", probability: 0.15),
